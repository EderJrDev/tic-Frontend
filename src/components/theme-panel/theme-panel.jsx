						...
						<div className="theme-panel-content" data-scrollbar="true" data-height="100%">
							...
							<div className="row mt-10px">
								<div className="col-8 control-label text-dark fw-bold">
									<div>Modo Noturmo <span className="badge bg-primary ms-1 py-2px position-relative" style={{ top: '-1px' }}>NOVO</span></div>
									<div className="lh-14">
										<small className="text-dark opacity-50">
											Ajuste a aparência para reduzir o brilho e dar um descanso aos olhos.
										</small>
									</div>
								</div>
							...
							<div className="row mt-10px align-items-center">
								<div className="col-8 control-label text-dark fw-bold">Sidebar Fixo</div>
								<div className="col-4 d-flex">
									<div className="form-check form-switch ms-auto mb-0">
							...
							<div className="row mt-10px align-items-center">
								<div className="col-8 control-label text-dark fw-bold">Sidebar Inverso</div>
								<div className="col-4 d-flex">
									<div className="form-check form-switch ms-auto mb-0">
							...
							<div className="row mt-10px align-items-center">
								<div className="col-md-8 control-label text-dark fw-bold">Gradiente ativado</div>
